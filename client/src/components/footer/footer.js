        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="">
              ...
              <p class="mb-4">
                <a href="#!" class="text-neutral-600 dark:text-neutral-200"> <Link to='/'>Home</Link> </a>
              </p>
              <p class="mb-4">
                <a href="#!" class="text-neutral-600 dark:text-neutral-200"><Link to='/productlist'>Product List</Link> </a >
              </p>
              <p class="mb-4">
                <a href="#!" class="text-neutral-600 dark:text-neutral-200 "><Link to='/cart'>My Cart</Link> </a>
              </p>
              {/* <p>
          <a href="#!" class="text-neutral-600 dark:text-neutral-200"
            >Laravel</a
          >
            ...
            <div>
              ...
              <p class="mb-4 flex items-center justify-center md:justify-start">
                ...
                4/153, Bharath School (Near) , <br/>
                Palladam Road, Vidhyalayam <br />
                Tirupur.
              </p>
