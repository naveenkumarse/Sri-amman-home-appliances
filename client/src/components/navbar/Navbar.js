...
const NavBar = () => {
    ...
    return (
        <div className="flex justify-between items-center flex-wrap h-42 relative bg-stone-300">
            ...
            <div className="text-dark flex justify-between items-center h-24 w-3/5 max-w-[1240px] ">

                <Link to="/"><h1 className="w-full text-3xl font-bold px-5"> Sri Amman Home Appliances </h1></Link>
